    ...
    <main className="mt-24  ">
      ...
      <div className="relative z-10  flex flex-col items-center rounded-lg p-7 text-center backdrop-blur-sm">
        ...
        <div className="flex items-center gap-8 rounded-md p-4 ">
          <Link
            href="/loan"
            className="line-clamp-1 rounded-md bg-green90 px-6 py-3 text-xl  font-semibold text-green10  hover:bg-green80"
          >
            Apply Loan
          </Link>
          <Link
            href="/dashboard"
            className="line-clamp-1 rounded-md bg-orange100 px-6 py-3 text-xl  font-semibold text-white  hover:bg-orange80"
          >
            Dashboard
          </Link>
        </div>
