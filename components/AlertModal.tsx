...
const AlertModal = ({ noticeExist }: { noticeExist: boolean }) => {
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger className="bg-dark90-light20 group flex w-full  items-center gap-3 rounded-md  px-2 py-1 text-start text-orange20 hover:text-orange60 hover:shadow-sm dark:hover:text-orange30">
        ...
        <span> {noticeExist ? "Remove Exit Notice" : "Place Exit Notice"}</span>
      </AlertDialogTrigger>
      <AlertDialogContent
        ...
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-[0.9rem]">
            {noticeExist ? (
              ...
              <p>
                This action requires you to clear you loans in one month, and
                ensure all loan you guaranteed are settled.{" "}
